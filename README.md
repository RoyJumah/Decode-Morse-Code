...
- In this respository we used methods to decode a morse code using Ruby
...
```JavaScipt
cd clone https://github.com/RoyJumah/Decode-Morse-Code.git
```
...
- Twitter: [@_alelignayana](https://twitter.com/)
- LinkedIn: [Alelign Ayana](https://www.linkedin.com/)
